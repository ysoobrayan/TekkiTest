package com.paloit.windows.chrome;
...
public class LoginWidgetVerification {
  ...
  private final static Logger LOGGER = Logger.getLogger(WindowsChromeRunner.class.getName());

  @Before
  public void setUp() throws Exception {
	System.out.println("Run Started Windows-Chrome!");
	Handler fileHandler  = new FileHandler("./src/com/paloit/windows/chrome/tekki_Windows_Chrome.log");
	LOGGER.addHandler(fileHandler);
	//Setting levels to handlers and LOGGER
	fileHandler.setLevel(Level.ALL);
	LOGGER.setLevel(Level.ALL);
	System.setProperty("webdriver.chrome.driver", "./Windows_Dependencies/chromedriver.exe");
